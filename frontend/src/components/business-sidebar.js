...
function BusinessSkeleton() {
  return (
    <div className="p-4 space-y-4">
      {[1, 2, 3].map((i) => (
        <div key={i} className="bg-card animate-pulse rounded-xl p-4 space-y-4">
          {/* Score skeleton */}
  ...
  return (
    <div className="p-4 space-y-4 animate-pulse">
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        <div className="bg-card p-3 rounded-lg col-span-2">
          <div className="h-4 bg-muted rounded w-24 mb-2"></div>
          <div className="flex gap-2">
            <div className="h-6 bg-muted rounded w-20"></div>
            <div className="h-6 bg-muted rounded w-24"></div>
...
export default function BusinessSidebar({
  ...
  return (
    <div className="fixed right-0 top-0 h-screen w-[480px] bg-background/95 backdrop-blur-sm shadow-2xl border-l overflow-hidden z-20 transition-transform duration-300 ease-in-out flex flex-col">
      ...
      {isLoading ? (
        <>
          <AnalysisSkeleton />
          <div className="border-b flex items-center justify-between bg-background/50 p-4">
